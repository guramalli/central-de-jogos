  ...
  return (
    <div>
      ...
      <p style={{ color: "var(--text-dim)" }}>
        ...
        que a sala está achando graça, não só na própria frase. <strong>Votar é obrigatório pra pontuar</strong>: quem não vota fica sem os pontos daquela rodada. O primeiro a enviar a frase da rodada
