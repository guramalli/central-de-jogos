...
//
// LETRAS U e Z VAZIAS: não encontrei peixe com essas letras cujo nome
// circule em português. Cheguei a escrever "Uruaçu" e "Zebrafish" — o
// primeiro eu não consegui confirmar e o segundo é inglês (em português é
// "paulistinha", que começa com P). Deixei vazias em vez de inventar.
//
...
export const PEIXES_WORDS = {
  A: [
    ...
    "Aruanã", "Abrótea", "Anequim",
  ],
  B: [
    "Badejo", "Betta", "Bacalhau", "Barbado",
    "Bonito", "Bicuda", "Barracuda",
  ],
  C: [
