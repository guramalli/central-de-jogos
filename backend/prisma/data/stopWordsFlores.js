...
export const FLORES_WORDS = {
  ...
  F: [
    ...
    "Flor-de-maio", "Flor-de-mel", "Flor-de-são-joão", "Flor-de-seda",
    "Flor-do-cardeal", "Flor-do-caribe", "Flor-do-deserto", "Flor-do-maracujá",
    "Flor-do-paraíso", "Forsythia", "Frangipani", "Frésia",
    "Fritilária", "Fumária",
  ],
  G: [
  ...
  S: [
    ...
    "Scilla", "Scutellaria", "Sedum", "Sempreviva",
    "Sene", "Senecio", "Serratula", "Serissa",
    "Silene", "Sinningia", "Sisyrinchium", "Skimmia",
    "Solandra", "Solanum", "Sophora", "Sparaxis",
    "Spiraea", "Stachys", "Stapelia", "Statice",
    "Sternbergia", "Stokesia", "Strelitzia", "Streptocarpus",
    "Sucupira", "Suspiro", "Sutera", "Symphytum",
    "Syringa",
  ],
  T: [
