...
export const COBRAS_WORDS = {
  A: [
    ...
    "Anaconda-verde", "Anfisbena", "Ashe-spitting-cobra", "Áspide",
    "Azulão-boia",
  ],
  B: [
    "Ball python", "Bico-de-jaca", "Bico-de-papagaio", "Black mamba",
    "Boa", "Boa-constritora", "Boca-de-algodão", "Boca-podre",
    "Boiaçu", "Boiatininga", "Boicoatiara", "Boicorá",
    "Boicotiara", "Boiguaçu", "Boipeba", "Boipeva",
    "Boipeva-d'água", "Boipinima", "Boiuna", "Boomslang",
    "Bothrops", "Bothrops-jararaca", "Brown-snake", "Bungarus",
    "Bushmaster",
  ],
  C: [
    "Caiçaca", "California kingsnake", "Caninana", "Cascavel",
    "Chironius", "Clelia", "Coatiara", "Cobra-arco-íris",
    "Cobra-bicuda", "Cobra-capelo", "Cobra-cega", "Cobra-cega-preta",
    "Cobra-cipó", "Cobra-cipó-listrada", "Cobra-cipó-malhada", "Cobra-cipó-marrom",
    "Cobra-corá", "Cobra-coral-anelada", "Cobra-coral-de-anéis", "Cobra-coral-de-cabeça-preta",
    "Cobra-coral-de-cabeça-vermelha", "Cobra-coral-de-cinta-branca", "Cobra-coral-de-costas-pretas", "Cobra-coral-fina",
    "Cobra-coral-pampeana", "Cobra-coral-pequena", "Cobra-coral-uruguaia", "Cobra-coral-vermelha",
    "Cobra-d'água", "Cobra-d'água-meridional", "Cobra-d'água-preta", "Cobra-d'água-serrana",
    "Cobra-da-morte", "Cobra-da-terra", "Cobra-de-caçote", "Cobra-de-cadarço",
    "Cobra-de-capelo", "Cobra-de-capim", "Cobra-de-chumbinho", "Cobra-de-duas-cabeças",
    "Cobra-de-esculápio", "Cobra-de-leite", "Cobra-de-listra-vermelha", "Cobra-de-parede",
    "Cobra-de-veado", "Cobra-do-lodo", "Cobra-do-mato", "Cobra-do-milho",
    "Cobra-do-rabo-branco", "Cobra-do-rio", "Cobra-espada", "Cobra-espada-de-água",
    "Cobra-espada-pampeana", "Cobra-espada-pintada", "Cobra-fio", "Cobra-garter",
    "Cobra-gato", "Cobra-grande", "Cobra-jericoá", "Cobra-liga",
    "Cobra-lisa", "Cobra-listrada", "Cobra-marinha", "Cobra-nariguda",
    "Cobra-nariguda-das-dunas", "Cobra-nebulosa", "Cobra-olho-de-gato", "Cobra-papagaio",
    "Cobra-paraíso", "Cobra-preta", "Cobra-rabo-de-pau", "Cobra-rajada",
    "Cobra-rateira", "Cobra-rei", "Cobra-rei-californiana", "Cobra-sol",
    "Cobra-topete", "Cobra-verde", "Cobra-vermelha", "Cobra-voadora",
    "Cobrinha-da-terra", "Comboia", "Copperhead", "Coral",
    "Coral snake", "Coral-de-cara-preta", "Coral-de-cintas-simples", "Coral-de-colar-branco",
    "Coral-falsa", "Coral-verdadeira", "Corallus", "Corn snake",
    "Corre-campo", "Corredeira", "Corredeira-do-banhado", "Corredeira-listrada",
    "Cotiara", "Cottonmouth", "Crossed pit viper", "Crotalus",
    "Cruzeira", "Cruzeiro", "Cuamboia", "Cuiama",
    "Cuiama-nariguda",
  ],
  D: [
    "Dama-d'água", "Death adder", "Dekay-brown-snake", "Dendroaspis",
    "Desert-king-snake", "Dione-rat-snake", "Dipsas", "Dorme-dorme",
    "Dormideira", "Dormideira-cipó", "Dormideira-cipó-cinzenta", "Dorminhoca",
    "Drymarchon", "Dwarf-water-cobra",
  ],
  E: [
  ...
  F: [
    ...
    "Falsa-muçurana", "False coral snake", "False fer-de-lance", "Focinho-de-porco",
    "Forest-cobra", "Foxsnake", "Fura-terra",
  ],
  G: [
    "Gaboon viper", "Garter snake", "Giboia", "Giboia-anã",
    "Giboia-branca", "Giboia-cinzenta", "Giboia-da-cauda-vermelha", "Giboia-do-cerrado",
    "Giboia-dormideira", "Giboia-rosada", "Gongylophis", "Gopher-snake",
  ...
  L: [
    ...
    "Leptophis", "Limpa-mato", "Limpa-pasto", "Lined-snake",
    "Liophis", "Long-nosed-snake",
  ],
  M: [
    "Malayan-pit-viper", "Mamba", "Mamba-negra", "Mamba-verde",
    "Mapanare", "Marine file snake", "Micrurus", "Milk snake",
    "Minhocão", "Mozambique-spitting-cobra", "Muçurana", "Muçurana-comum",
    "Muçurana-nariguda", "Mussurana",
  ],
  N: [
    "Naja-cuspideira", "Naja-cuspideira-anelada", "Nariguda", "Nariguda-comum",
    "Nariguda-grande", "Nariguda-preta", "Night-snake", "Northern-water-snake",
  ...
  P: [
    "Papa-lesma", "Papa-ovo", "Papa-pinto", "Paramboia",
    "Periquitambóia", "Philodryas", "Pico-de-jaca", "Pine-snake",
    "Píton", "Píton-birmanesa", "Píton-bola", "Píton-real",
    "Píton-reticulada", "Pseudoboa", "Puff-adder", "Python",
  ],
  Q: [
    "Quatro-ventas", "Queen-snake", "Queimada-grande",
  ],
  R: [
    "Rabo-de-fino", "Rabo-de-mucura", "Rabo-de-mulita", "Rabo-de-pavio",
    "Rabo-de-porco", "Rainbow boa", "Rat-snake", "Rateira",
    "Ratsnake", "Rattlesnake", "Reticulated python", "Rhinoceros-viper",
    "Ringhals", "Ringneck-snake", "Rinkhals", "Russell-viper",
  ],
  S: [
    "Salamanta", "Salamanta-boi", "Sand boa", "Sand viper",
    "Saw-scaled viper", "Sea snake", "Serpente-do-mar", "Sibynomorphus",
    "Sidewinder", "Snail-eating snake", "South American bushmaster", "Spilotes",
    "Spitting cobra", "Suaçubóia", "Sucuri", "Sucuri-amarela",
    "Sucuri-de-patioba", "Sucuri-do-pantanal", "Sucuri-pinta-de-ouro", "Sucuri-verde",
    "Sucurijú", "Sucurijuba", "Sucurucurana", "Sunbeam snake",
    "Surucucu", "Surucucu-bico-de-jaca", "Surucucu-cospe-fogo", "Surucucu-da-várzea",
    "Surucucu-de-fogo", "Surucucu-de-ouricana", "Surucucu-de-patioba", "Surucucu-de-pindoba",
    "Surucucu-do-barranco", "Surucucu-pico-de-jaca", "Surucucu-pinta-de-ouro", "Surucucu-vermelha",
    "Surucutinga",
  ],
  T: [
    "Taipan", "Taipan-da-costa", "Taipan-do-interior", "Tantilla",
    "Thamnodynastes", "Tiger-snake", "Trairamboia", "Tropidodryas",
    "Twig-snake",
  ],
  U: [
