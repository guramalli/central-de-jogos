...
import { GAMES_PC } from "./data/quizGamesPC.js";

const prisma = new PrismaClient();

async function main() {
  let inseridas = 0, puladas = 0;
  for (const [themeKey, perguntas] of Object.entries(GAMES_PC)) {
  ...
  console.log(`✅ ${inseridas} pergunta(s) nova(s) de games (PC), ${puladas} já existiam.`);
}
