// Importa (ou atualiza) o tema "Carros" do Stop.
//
...
//
// Uso:  npm run import-carros
import { PrismaClient } from "@prisma/client";
import { CARROS_WORDS } from "./data/stopWordsCarros.js";
...
async function main() {
  ...
  for (const [letra, palavras] of Object.entries(CARROS_WORDS)) {
